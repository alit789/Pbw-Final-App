      ...
      <Row>
        <Col>
          <div className="testimoniContainer">
            <h3 className="text-center" style={{color:'var(--blue)'}}>Testimoni Pengguna Motion</h3>
            <p className="text-center">Beberapa Testimoni dari para pelanggan kami Setia Kmai</p>
            <div className="testimoniContent py-3">
              <Carousel variant="dark" fade>
                <Carousel.Item className="d-flex gap-5 justify-content-center">
                  <CardCorosel
                    img={"https://awsimages.detik.net.id/community/media/visual/2023/01/26/toru-ueda-terobsesi-jadi-serigala_43.png?w=1200"}
                ...
                <Carousel.Item className="d-flex gap-5 justify-content-center">
                  <CardCorosel
                  img={"https://awsimages.detik.net.id/community/media/visual/2022/02/11/monyet.jpeg?w=1200"}
                ...
                <Carousel.Item className="d-flex gap-5 justify-content-center">
                  <CardCorosel
                  img={"https://asset-a.grid.id/crop/0x0:0x0/x/photo/2022/07/07/harimau-sumatrajpg-20220707025512.jpg"}
